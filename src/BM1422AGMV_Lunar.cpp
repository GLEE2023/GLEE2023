...
void BM1422AGMV_Lunar::setConfig(uint8_t config){
  ...
  */
  ...
  //step 1
  Lunar_I2C::writeByte(BM1422AGMV_DEVICE_ADDRESS_0E,BM1422AGMV_CNTL1,((config & 0x8)<<7) | (0x40) | ((config & 0x3)<<3) | ((config & 0x01)<<0));
...
void BM1422AGMV_Lunar::getData(uint8_t* buffer){
  Lunar_I2C::writeByte(BM1422AGMV_DEVICE_ADDRESS_0E,BM1422AGMV_CNTL3+1, 0x4);
